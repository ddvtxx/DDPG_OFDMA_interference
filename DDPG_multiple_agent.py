...
for i in range(4):
    DDPG_agent=globals()[f"DDPG_agent_{i}"] = DDPG(
        ...
        critic_fc4_dim=2**6,
        ckpt_dir='./DDPG'+str(i)+'/',
        gamma=0.99,tau=0.001,action_noise=1e-4,max_size=1000000,batch_size=128)
...
dataframe.to_csv("./result/bitrate_multiple_waterFilling_1e-4_1000000.csv", index=False,sep=',')