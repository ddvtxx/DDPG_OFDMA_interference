    ...
    for i_loop in range(4):
        ...
        for i_episode in range(episode):
            ...
            for i_iteration in range(max_iteration):
                ...
                system_bitrate_general = test_env.calculate_4_cells_without_wf(RU_mapper)
                ...
                if (system_bitrate<system_bitrate_general):
                    key_value = system_bitrate_general/(1e+4)
                    action_0 = RU_mapper[3,:,:]
                else:
